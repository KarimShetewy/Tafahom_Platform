    ...
    def validate(self, data):
        ...
        if material_type == 'video' or material_type == 'pdf':
            ...
            if 'quiz_details' in data and data['quiz_details']:
                ...
                # إذا لم يتم إرسال quiz_details عند إنشاء quiz/exam
                # يمكن السماح بإنشاء مادة quiz/exam فارغة ثم تحديثها لاحقاً
                # أو فرض وجود أسئلة مبدئية هنا
                pass
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'teacher', 'teacher_name', 'teacher_last_name', 'teacher_id', 'teacher_profile_image',
                  ...
                  'lectures'] # إضافة lectures

        read_only_fields = ['id', 'teacher', 'teacher_name', 'teacher_last_name', 'teacher_id', 'teacher_profile_image',
                            'created_at', 'updated_at', 'lectures', 'academic_level_display', 'subject_display', 'course_type_display', 'image_url']
        extra_kwargs = {
